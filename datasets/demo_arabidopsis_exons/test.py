...
def generate_gff3_df():
    read_in_file = read_gff3('/Users/filipr/Desktop/checkpoints/genomic_benchmarks/datasets/demo_arabidopsis_exons/Athaliana_167_TAIR10.gene_exons.gff3')
    return read_in_file

input = generate_gff3_df()
print(input.stats_dic())
